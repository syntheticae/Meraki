      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-12 pb-28 sm:pb-36 space-y-10">
        ...
        <div className="space-y-4 max-w-3xl">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-xs text-[#50585C] dark:text-[#7A8992]">· Cambridge & IDP Standard</span>
          </div>
              ...
              <Link key={l.id} href={`/learn/ielts-prep/${l.slug}`}>
                <div className="p-6 rounded-3xl bg-[#FFFFFF] dark:bg-[#141414] hover:bg-[#EDF3F7] dark:bg-[#1C1C1C] border border-[#BFD8E3]/40 dark:border-white/10 transition-all tactile-btn space-y-3 shadow-xs group h-full flex flex-col justify-between">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-[10px] bg-[#00638E]/15 dark:bg-[#00638E]/25 text-[#00638E] dark:text-[#8CB9CC] px-2.5 py-0.5 rounded-md font-bold">
                        Pelajaran {l.order}
                      </span>
        ...
        <div className="p-8 sm:p-10 rounded-3xl bg-[#00638E] text-white shadow-xs font-semibold border border-[#BFD8E3]/40 dark:border-white/10 space-y-4 shadow-lg">
          <span className="font-mono text-xs uppercase tracking-widest text-[#00638E] dark:text-[#8CB9CC] font-bold block">
          ...
          <div className="pt-2">
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-[#00638E] text-white hover:bg-[#8e3c1e] text-white text-xs font-mono font-semibold transition-all shadow-sm tactile-btn"
            >

        ...
        <div className="p-8 sm:p-10 rounded-3xl bg-[#00638E] text-white shadow-xs font-semibold border border-[#BFD8E3]/40 dark:border-white/10 space-y-4 shadow-lg">
          ...
          <div className="pt-2">
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-[#00638E] text-white hover:bg-[#004A6B] text-xs font-mono font-semibold transition-all shadow-sm tactile-btn"
            >
